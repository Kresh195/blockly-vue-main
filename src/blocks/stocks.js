...
Blockly.Blocks['block_movement_left'] = {
  init: function() {
    this.appendDummyInput()
...
Blockly.JavaScript['block_movement_left'] = function(block) {
  var count_steps = block.getFieldValue('COUNT');
  // TODO: Assemble JavaScript into code variable.
  console.log('шаг влево',count_steps)
  var code = 'turnLeft();\n';
  return code;
};

Blockly.Blocks['block_movement_right'] = {
  init: function() {
    this.appendDummyInput()
...
Blockly.JavaScript['block_movement_right'] = function() {
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnRight();\n';
  return code;
};
...
Blockly.JavaScript['block_move_forward'] = function() {
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['block_start'] = function() {
  // TODO: Assemble JavaScript into code variable.
  var code = '\n';
  return code;
};
